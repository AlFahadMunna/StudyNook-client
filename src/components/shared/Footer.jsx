        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            ...
            <p className="text-muted text-sm leading-relaxed">
              StudyNook provides a seamless way for students to book private
              library study rooms, ensuring focus and productivity without the
              hassle of double-bookings.
            </p>
          </div>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileHover={{ y: -5 }}
                  className="w-10 h-10 rounded-xl bg-default-100 flex items-center justify-center text-foreground hover:bg-accent hover:text-accent-foreground transition-all shadow-sm"
